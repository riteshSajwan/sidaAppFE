...
import { TransactionStatus, TransactionStatusLabel } from 'src/components/Booking/BookingWallet/BookingWalletListUtil';
import { useWalletStyle } from 'src/components/Booking/BookingWallet/Table/BookingWalletListStyle';
import { IWalletListWithActions, WalletListTableProps } from 'src/components/Booking/BookingWallet/Table/BookingWalletListTableUtil';
import { IWallet } from 'src/components/DriverDetailPage/DriverWallet/DriverWalletListUtil';

const BookingWalletListTable = ({
  walletListData,
  page,
  handleSort,
  filter,
...
export default BookingWalletListTable;
